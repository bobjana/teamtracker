...
import za.co.zynafin.teamtracker.TeamTrackerException;
    ...
    public static Account obtainDefaultAccount(Context context) {
        if (defaultAccount == null) {
            ...
            if (accounts.length == 0) {
                throw new TeamTrackerException(R.string.default_google_account_does_not_exist,"No accounts present");
            }
            ...
            if (defaultAccount == null){
                throw new TeamTrackerException(R.string.default_google_account_does_not_exist, "Google account does not exist"/*R.string.default_google_account_does_not_exist*/);
            }
        }
